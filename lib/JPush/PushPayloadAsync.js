...
function android (alert, title, builder_id, extras, priority, category, style, value, alertType, channelId) {
  if (alert != null) {
  ...
  if (channelId != null) {
    if (typeof channelId !== 'string') {
      throw new JError.InvalidArgumentError('Invalid android.channelId, it only can be set to the string')
    }
    android['channel_id'] = channelId
  }
...
async function setSchedule (name, enabled) {
...
async function updateSchedule (scheduleId, name, enabled) {
